$.get("xml/boardGamesWebsite.xml", function (xml) {
    ...
    $(xml).find("boardGames").each(function () {
        ...
        let votes = $(this).find("description").text();
        text += "<div class='row'><div class='col-2 col-lg-1 headercol'>" + i + "</div><div class='col-6 col-lg-3 oddrow'>" + name + "</div><div class='col-4 col-lg-2 oddrow'>" + numberOfPlayers + "</div><div class='col-5 oddrow d-none d-lg-block'>" + description + "</div><div class='col-1 oddrow d-none d-lg-block'>" + votes + "</div></div>";
        i++;
    });
    ...
    $(xml).find("boardGames").each(function () {
        let numberOfPlayers = $(this).find("numberOfPlayers").text();
        let description = $(this).find("description").text();
        let averageRating = $(this).find("description").text();
        text += "<div class='row d-lg-none'><div class='col-2 headercol'>" + j + "</div><div class='col-8 oddrow'>" + description +"</div><div class='col-2 oddrow'>" + averageRating + "</div></div>";
        j++;
    });
